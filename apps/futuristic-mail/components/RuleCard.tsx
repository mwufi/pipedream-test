...
import { Paperclip, Check, X, Edit, Trash2 } from 'lucide-react';
            ...
            <div className="px-4 py-3 space-y-2">
                <div className="flex flex-col gap-xs">
                    <textarea
                        ...
                        className="w-full text-md bg-transparent text-input-text placeholder:text-input-text-placeholder resize-none outline-none rounded-input px-3 py-2.5 overflow-hidden h-auto cursor-default"
